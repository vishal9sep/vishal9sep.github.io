      ...
      <div className="project__main">
        <div data-aos="fade-right" className="project__left">
          ...
          <p className="project__description project__body">
            A Movie App project just like IMDB created during the bootcamp. I
            have used IMDB API. Features: Favourite Section - I have implemented
            Debouncing concept in the search section. It was a solo project,
            executed in 6 hours.
          </p>
